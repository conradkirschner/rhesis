...
export default function RefreshTokenModal({ open, onClose, onRefresh, tokenName }: Props) {
  ...
  return (
    <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
      <form onSubmit={handleSubmit}>
          ...
          <Box sx={{ mt: 2, display: 'flex', flexDirection: 'column', gap: 2 }}>
            <FormControl fullWidth>
              ...
              <Select
                ...
                inputProps={{ 'data-test-id': 'refresh-expiration' }}
              >
                ...
                <DatePicker
                  ...
                  slotProps={{
                    textField: {
                      required: true,
                      fullWidth: true,
                      inputProps: { 'data-test-id': 'refresh-expiration-date' },
                    },
                  }}
                />
        ...
        <DialogActions>
          <Button onClick={handleClose} data-test-id="cancel-refresh-token">Cancel</Button>
          <Button type="submit" variant="contained" data-test-id="confirm-refresh-token">
            OK
          </Button>
        </DialogActions>
      </form>
