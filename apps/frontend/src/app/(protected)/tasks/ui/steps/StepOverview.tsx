...
type InputPropsWithData = React.InputHTMLAttributes<HTMLInputElement> & {
  'data-test-id'?: string;
};
            ...
            <TableRow>
              <TableCell padding="checkbox">
                <Checkbox
                  ...
                  inputProps={{ 'data-test-id': 'select-all' } as InputPropsWithData}
                />
              </TableCell>
                ...
                >
                  <TableCell padding="checkbox" onClick={(e) => e.stopPropagation()}>
                    <Checkbox
                      ...
                      inputProps={{ 'data-test-id': `select-${row.id}` } as InputPropsWithData}
                    />
                  </TableCell>
                  <TableCell>
