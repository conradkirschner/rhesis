...
import { Box, Typography, Avatar, Chip,  Autocomplete, TextField  } from '@mui/material';
      ...
      <Box sx={{ display: 'grid', gap: 2 }}>
        ...
        <Box sx={{ mt: 2 }}>
          <BaseDataGrid<UiTestRunRow>
              ...
              onRowSelectionModelChange={(ids) => grid.onSelectionChange(ids.map(String))}
              rowSelectionModel={grid.selection}
              onRowClick={(params) => grid.onRowClick(String(params.id))}
              ...
              <TextField
                  ...
                  InputProps={{
                    ...
                    startAdornment: value ? (
                        <Avatar src={value.picture ?? undefined} sx={{ width: 24, height: 24, mr: 1 }}>
                          <PersonIcon fontSize="small" />
                        </Avatar>
                    ) : undefined,
                  }}
...
function SimpleAutocomplete<T extends { id: string }>({
                                                        label,
                                                        options,
                                                        value,
                                                        onChange,
