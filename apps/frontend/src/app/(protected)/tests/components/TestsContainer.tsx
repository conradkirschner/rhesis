...
export default function TestsContainer() {
  ...
  return (
    <FeaturePageFrame title="Tests" breadcrumbs={[{ title: 'Tests', path: '/tests' }]}>
      ...
      <StepTestsTable
          /*TS2322: Type readonly UiTestRow[] is not assignable to type readonly UiNewTestRow[]
Type UiTestRow is missing the following properties from type UiNewTestRow: testType, promptContent, priority, statusName
types.ts(61, 12): The expected type comes from property rows which is declared here on type IntrinsicAttributes & UiStepNewTestsGridProps*/
        rows={uiRows}
        ...
        /*TS7006: Parameter odata implicitly has an any type.*/
