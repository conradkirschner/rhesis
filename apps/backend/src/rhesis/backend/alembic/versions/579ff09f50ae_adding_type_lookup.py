...
def upgrade() -> None:
    ...
    op.add_column(
        "category", sa.Column("entity_type_id", GUID(), nullable=True)
    )
    op.create_foreign_key(None, "category", "type_lookup", ["entity_type_id"], ["id"])
    op.drop_column("category", "entity_type")
    op.add_column(
        "response_pattern",
        sa.Column("response_pattern_type_id", GUID(), nullable=True),
    )
    ...
    op.add_column(
        "topic", sa.Column("entity_type_id", GUID(), nullable=True)
    )
