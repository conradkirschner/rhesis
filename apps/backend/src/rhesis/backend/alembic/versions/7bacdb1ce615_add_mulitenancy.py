...
def upgrade() -> None:
    ...
    op.add_column(
        "behavior", sa.Column("organization_id", GUID(), nullable=True)
    )
    op.add_column("behavior", sa.Column("user_id", GUID(), nullable=True))
    op.create_foreign_key(None, "behavior", "user", ["user_id"], ["id"])
    op.create_foreign_key(None, "behavior", "organization", ["organization_id"], ["id"])
    op.add_column(
        "category", sa.Column("organization_id", GUID(), nullable=True)
    )
    op.add_column("category", sa.Column("user_id", GUID(), nullable=True))
    op.create_foreign_key(None, "category", "user", ["user_id"], ["id"])
    op.create_foreign_key(None, "category", "organization", ["organization_id"], ["id"])
    op.add_column(
        "demographic", sa.Column("organization_id", GUID(), nullable=True)
    )
    op.add_column("demographic", sa.Column("user_id", GUID(), nullable=True))
    ...
    op.add_column(
        "dimension", sa.Column("organization_id", GUID(), nullable=True)
    )
    op.add_column("dimension", sa.Column("user_id", GUID(), nullable=True))
    op.create_foreign_key(None, "dimension", "organization", ["organization_id"], ["id"])
    op.create_foreign_key(None, "dimension", "user", ["user_id"], ["id"])
    op.add_column(
        "prompt", sa.Column("organization_id", GUID(), nullable=True)
    )
    ...
    op.add_column(
        "response_pattern", sa.Column("user_id", GUID(), nullable=True)
    )
    ...
    op.add_column(
        "risk", sa.Column("organization_id", GUID(), nullable=True)
    )
    op.add_column("risk", sa.Column("user_id", GUID(), nullable=True))
    op.create_foreign_key(None, "risk", "user", ["user_id"], ["id"])
    op.create_foreign_key(None, "risk", "organization", ["organization_id"], ["id"])
    op.add_column(
        "source", sa.Column("organization_id", GUID(), nullable=True)
    )
    op.add_column("source", sa.Column("user_id", GUID(), nullable=True))
    op.create_foreign_key(None, "source", "organization", ["organization_id"], ["id"])
    op.create_foreign_key(None, "source", "user", ["user_id"], ["id"])
    op.add_column(
        "status", sa.Column("organization_id", GUID(), nullable=True)
    )
    op.add_column("status", sa.Column("user_id", GUID(), nullable=True))
    op.create_foreign_key(None, "status", "organization", ["organization_id"], ["id"])
    op.create_foreign_key(None, "status", "user", ["user_id"], ["id"])
    op.add_column(
        "subscription", sa.Column("organization_id", GUID(), nullable=True)
    )
    op.create_foreign_key(None, "subscription", "organization", ["organization_id"], ["id"])
    op.add_column("tag", sa.Column("organization_id", GUID(), nullable=True))
    op.create_foreign_key(None, "tag", "organization", ["organization_id"], ["id"])
    op.add_column(
        "test", sa.Column("organization_id", GUID(), nullable=True)
    )
    ...
    op.add_column(
        "test_context", sa.Column("organization_id", GUID(), nullable=True)
    )
    op.add_column(
        "test_context", sa.Column("user_id", GUID(), nullable=True)
    )
    ...
    op.add_column(
        "test_result", sa.Column("organization_id", GUID(), nullable=True)
    )
    op.create_foreign_key(None, "test_result", "organization", ["organization_id"], ["id"])
    op.add_column(
        "test_run", sa.Column("organization_id", GUID(), nullable=True)
    )
    ...
    op.add_column(
        "token", sa.Column("organization_id", GUID(), nullable=True)
    )
    op.create_foreign_key(None, "token", "organization", ["organization_id"], ["id"])
    op.add_column(
        "topic", sa.Column("organization_id", GUID(), nullable=True)
    )
    op.add_column("topic", sa.Column("user_id", GUID(), nullable=True))
    op.create_foreign_key(None, "topic", "organization", ["organization_id"], ["id"])
    op.create_foreign_key(None, "topic", "user", ["user_id"], ["id"])
    op.add_column(
        "type_lookup", sa.Column("organization_id", GUID(), nullable=True)
    )
    op.add_column("type_lookup", sa.Column("user_id", GUID(), nullable=True))
    ...
    op.add_column(
        "use_case", sa.Column("organization_id", GUID(), nullable=True)
    )
    op.add_column("use_case", sa.Column("user_id", GUID(), nullable=True))
