...
def upgrade() -> None:
    ...
    op.add_column(
        "prompt_test_set", sa.Column("user_id", GUID(), nullable=True)
    )
    op.add_column(
        "prompt_test_set",
    ...
    op.add_column(
        "prompt_use_case", sa.Column("user_id", GUID(), nullable=True)
    )
    op.add_column(
        "prompt_use_case",
        sa.Column("organization_id", GUID(), nullable=True),
    ...
    op.add_column(
        "risk_use_case", sa.Column("user_id", GUID(), nullable=True)
    )
    op.add_column(
        "risk_use_case", sa.Column("organization_id", GUID(), nullable=True)
    )
    ...
    op.add_column("tag", sa.Column("user_id", GUID(), nullable=True))
    op.create_foreign_key(None, "tag", "user", ["user_id"], ["id"])
    op.add_column(
        "tagged_item", sa.Column("organization_id", GUID(), nullable=True)
    )
    op.add_column("tagged_item", sa.Column("user_id", GUID(), nullable=True))
    ...
    op.add_column(
        "test_test_set", sa.Column("user_id", GUID(), nullable=True)
    )
    op.add_column(
        "test_test_set", sa.Column("organization_id", GUID(), nullable=True)
    )
