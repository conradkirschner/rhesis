      ...
      <Card sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
        <CardContent sx={{ flexGrow: 1, p: 3 }}>
          ...
          >
            ...
            <Box sx={{ color: iconColors[color], display: 'flex', alignItems: 'center' }}>
              {icon}
            </Box>
          </Box>
                    ...
                    >
                      ...
                      >
                        <Typography
                            ...
                            sx={{ transition: 'color 0.2s', color: 'text.secondary', fontWeight: 500 }}
                        >
                    ...
                    >
                      ...
                      >
                        <Typography
                            ...
                            sx={{ transition: 'color 0.2s', color: 'text.secondary', fontWeight: 200 }}
                        >
                          Endpoint:{' '}
